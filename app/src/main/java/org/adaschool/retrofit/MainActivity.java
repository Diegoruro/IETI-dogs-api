...
import org.adaschool.retrofit.network.BreedsListDto;
import org.adaschool.retrofit.network.DogApiService;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadDogInfo() {
        String dogImageUrl = "https://dog.ceo/api/breeds/image/random";
